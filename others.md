...
<!-- ~~~
<div style="display: flex; flex-wrap: wrap; gap: 15px; justify-content: center; align-items: flex-end; margin: 30px 0;">
  <figure style="margin: 0; max-width: 130px;">
    <a href="/dance_pics/rehearse_w_igal.jpg" target="_blank">
      <img src="/dance_pics/rehearse_w_igal.jpg" alt="In the studio with Igal Perry at Peridance" style="width: 100%; display: block;">
    </a>
    <figcaption style="margin-top: 5px; font-size: 0.5em; color: #666; text-align: center;">In the studio with Igal Perry, Peridance.</figcaption>
  </figure>
  <figure style="margin: 0; max-width: 130px;">
    <a href="/dance_pics/nutcracker.jpg" target="_blank">
      <img src="/dance_pics/nutcracker.jpg" alt="Performing in The Nutcracker at Ballet West" style="width: 100%; display: block;">
    </a>
    <figcaption style="margin-top: 5px; font-size: 0.5em; color: #666; text-align: center;">The Nutcracker, Ballet West.</figcaption>
  </figure>
  <figure style="margin: 0; max-width: 130px;">
    <a href="/dance_pics/fourt.jpg" target="_blank">
      <img src="/dance_pics/fourt.jpg" alt="Melancholic in Balanchine's The Four Temperaments" style="width: 100%; display: block;">
    </a>
    <figcaption style="margin-top: 5px; font-size: 0.5em; color: #666; text-align: center;">Melancholic in Balanchine's <em>The Four Temperaments</em>.</figcaption>
  </figure>
  <figure style="margin: 0; max-width: 130px;">
    <a href="/pics/jackson.jpg" target="_blank">
      <img src="/pics/jackson.jpg" alt="With Zhang Xi and Cao Shuci at USA IBC 2010" style="width: 100%; display: block;">
    </a>
    <figcaption style="margin-top: 5px; font-size: 0.5em; color: #666; text-align: center;">With Zhang Xi and Cao Shuci (National Ballet of China) at USA IBC 2010.</figcaption>
  </figure>
</div>
~~~ -->
...
<a style="color:grey" href="https://www.kcb.org.tw/">KCB</a>, and to <a style="color:grey" href="https://www.cloudgate.org.tw/en/cg">Cloud Gate</a> for sponsoring me through the <a style="color:grey" href="https://en.wikipedia.org/wiki/Lo_Man-fei">Lo Man-Fei</a> Dance Fund.
</small></span>
~~~